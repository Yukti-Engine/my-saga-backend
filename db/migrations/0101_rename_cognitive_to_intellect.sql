ALTER TABLE users RENAME COLUMN cognitive_index TO intellect_index;
...
CREATE OR REPLACE FUNCTION apply_stat_changes(
  p_user_id INT,
  p_intellect FLOAT8, p_drive FLOAT8, p_adaptability FLOAT8,
  p_empathy FLOAT8, p_creativity FLOAT8
) RETURNS TABLE (
  intellect_index FLOAT8, drive_index FLOAT8, adaptability_index FLOAT8,
