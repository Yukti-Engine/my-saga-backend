-- FUNCTION: public.match_request(integer, text, integer, integer, integer, double precision, integer, integer, integer, integer, double precision, integer, integer, integer, double precision, double precision, double precision, double precision, boolean, boolean)

-- DROP FUNCTION IF EXISTS public.match_request(integer, text, integer, integer, integer, double precision, integer, integer, integer, integer, double precision, integer, integer, integer, double precision, double precision, double precision, double precision, boolean, boolean);
...
CREATE OR REPLACE FUNCTION public.match_request(
	...
	p_pay_per_head2 double precision,
	...
	p_snapshot_pay_per_head2 double precision,
