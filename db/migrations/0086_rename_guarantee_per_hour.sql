ALTER TABLE venues RENAME COLUMN guarantee_per_head TO guarantee_per_head_per_hour;
...
CREATE OR REPLACE FUNCTION create_venue(
  ...
  p_guarantee_per_head_per_hour DECIMAL(10,2) DEFAULT NULL
) RETURNS INT AS $$
DECLARE
  v_id INT;
BEGIN
  INSERT INTO venues (venue_name, venue_link, venue_lat, venue_long, venue_partner_id, head_count_limit, guarantee_per_head_per_hour)
  VALUES (p_name, p_link, p_lat, p_long, p_partner_id, p_head_count_limit, p_guarantee_per_head_per_hour)
...
RETURNS TABLE (
  ...
  guarantee_per_head_per_hour DECIMAL(10,2),
  partner_name VARCHAR(255)
) AS $$
BEGIN
  RETURN QUERY
    SELECT v.venue_id, v.venue_name, v.venue_link, v.venue_lat, v.venue_long,
           v.created_at, v.venue_partner_id, v.head_count_limit, v.guarantee_per_head_per_hour,
