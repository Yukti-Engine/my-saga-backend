...
router.post("/add-alloted-schedule", authSuperToken, addAllotedSchedule);
router.post("/venue-schedules", authSuperToken, getSchedulesForVenue);
router.post("/remove-alloted-schedule", authSuperToken, removeAllotedSchedule);
